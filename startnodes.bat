...
start python main.py --host 127.0.0.1 --port 5002 --peers "127.0.0.1:5000,127.0.0.1:5001"
start python main.py --host 127.0.0.1 --port 5003 --peers "127.0.0.1:5001"
start python main.py --host 127.0.0.1 --port 5004 --peers "127.0.0.1:5002"